...
public class PslPackageImpl extends EPackageImpl implements PslPackage {
	 ...
	 */
	@Override
	public EReference getProject_Skills() {
	 ...
	 */
	@Override
	public EReference getPerson_Skills() {
	...
	public void createPackageContents() {
		...
		createEReference(projectEClass, PROJECT__SKILLS);
		...
		createEReference(personEClass, PERSON__SKILLS);
	...
	public void initializePackageContents() {
		...
		initEReference(getProject_Skills(), this.getSkill(), null, "skills", null, 0, -1, Project.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getPerson_Skills(), this.getSkill(), null, "skills", null, 0, -1, Person.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
