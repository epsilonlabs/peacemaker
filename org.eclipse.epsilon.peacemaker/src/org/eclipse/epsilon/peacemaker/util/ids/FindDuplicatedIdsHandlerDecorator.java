...
public class FindDuplicatedIdsHandlerDecorator extends DefaultHandler implements XMLDefaultHandler {
	...
	public FindDuplicatedIdsHandlerDecorator(XMLResource resource, XMLDefaultHandler target,
			List<String> duplicatedIds, boolean stopWithFirst) {
		...
		xmiHelper = new XMIHelperImpl(resource);
	}
		...
		if (feature instanceof EReference) {
			...
			if (xsiType != null) {
				...
				if (prefix != null) {
					String packageUri = xmiHelper.getURI(prefix);
					EPackage epackage =
							resource.getResourceSet().getPackageRegistry().getEPackage(packageUri);
					if (epackage != null) {
